...
const sizePresets = [
  { label: "30×30 cm", ratio: "1 / 1" },      // cuadrado
  { label: "60×30 cm", ratio: "2 / 1" },      // horizontal
  { label: "60×80 cm", ratio: "3 / 4" },      // vertical
  { label: "40×40 cm", ratio: "1 / 1" },      // cuadrado
  { label: "50×40 cm", ratio: "5 / 4" },      // horizontal leve
  { label: "120×80 cm", ratio: "1 / 3" }      // horizontal amplio
];
